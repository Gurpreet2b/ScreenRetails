...
@Component({
  ...
  styleUrls: ['./expiry-alert.component.css'],
})
export class ExpiryAlertComponent implements OnInit {
  ...
  public SkinId: any;
  public AlertRSVPEditTitle: any;
  public AlertRSVPEditBody: any;
  public IsRSVPClose: any;
  public questionSelected2RSVP: any;
  public AlertBgImg: any;
  public HeaderText: any;
  public questionSelectedOptn: any;
  public questionSelectedOptn2: any;
  ...
  ngOnInit(): void {
    this.authService.SetRestaurantName(`Expired Alerts`);
    this.GetSentList(1);
  ...
  GetSentList(page: number) {
    ...
    this.http.get(`alerts_database/expired_alerts_list/?search=${search}&alert_type=${this.filterType}`, null, { params: params }).subscribe((res: any) => {
