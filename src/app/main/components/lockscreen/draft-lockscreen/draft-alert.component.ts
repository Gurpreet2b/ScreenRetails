...
export class DraftWallpaperComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.authService.SetRestaurantName(`Lockscreens Draft`);
  ...
  GetLockScreenList(page: number) {
    ...
    this.http.get(`lockscreenalert/dashboard_draft_list/?search=${search}`, null, { params: params }).subscribe((res: any) => {
