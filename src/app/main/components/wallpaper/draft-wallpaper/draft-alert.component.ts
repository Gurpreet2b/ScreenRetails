...
export class DraftWallpaperComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.authService.SetRestaurantName(`Draft Wallpapers`);
  ...
  GetWallpaperList(page: number) {
    ...
    this.http.get(`wallpaperalert/dashboard_draft_list/?search=${search}`, null, { params: params }).subscribe((res: any) => {
